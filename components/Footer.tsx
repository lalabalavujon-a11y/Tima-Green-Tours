        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="mailto:bookings@timagreentours.com" className="text-brand-emerald-400 hover:text-brand-emerald-300 transition-colors">
                📧 Email
              </a>
              <a href="https://wa.me/6790000000" className="text-brand-emerald-400 hover:text-brand-emerald-300 transition-colors">
                📱 WhatsApp
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/contact" className="text-brand-white/80 hover:text-brand-emerald-400 transition-colors">Contact</a></li>
